...
import 'package:mymoviesapp/Presentation/Home/Tabs/Home/TopRatedMovies/MoviesLists.dart';
    ...
    return ChangeNotifierProvider(
      ...
      child: Consumer<HomeTabViewModel>(
        builder: (context, value, child) {
          ...
          if (value.movies == null || value.actionMovies == null) {
            return const Center(
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    Movieslist(movies: value.actionMovies!)
                  ],
                )
              ),
            );
